scoreboard players reset @s buy_shears
#copy
...
loot give @s loot items:tools/shears
scoreboard players set @s rank_shears 1

tellraw @s [{"text": "Shears","color": "gold"},{"text": " を購入しました。","color": "green"}]
