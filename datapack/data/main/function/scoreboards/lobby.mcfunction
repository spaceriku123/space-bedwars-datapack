...
scoreboard objectives modify lobby displayname {"text": "Bed Wars","color": "gold","bold": true}
...
scoreboard players display name $credit lobby {"text": "SPACE-BW-DP v0.2.0","color": "yellow"}