...
execute as @a at @s run playsound entity.wither.death master @s ~ ~ ~ 0.5

title @a times 10 40 10
title @a subtitle {"text": "全チームのベッドが破壊された！","color": "white"}
title @a title {"text": "ベッドが破壊された！","bold":true,"color": "red"}
...
#timer reset
scoreboard players display name $time info [{"text": "Sudden Death -> ","color": "light_purple"},{"text": "10:00","color": "white"}]
