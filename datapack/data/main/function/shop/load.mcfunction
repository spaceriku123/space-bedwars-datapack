...
#item shop
    ...
    execute if score $npc random matches 5 at @e[type=armor_stand,tag=shop1] run summon warden ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,DeathLootTable:"main:empty",NoAI:1b,Tags:["shop","npcshop1","npc"],attributes:[{id:"minecraft:scale",base:0.6}]}
...
#team upgrades
    ...
    execute if score $npc random matches 5 at @e[type=armor_stand,tag=shop2] run summon warden ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,DeathLootTable:"main:empty",NoAI:1b,Tags:["shop","npcshop2","npc"],attributes:[{id:"minecraft:scale",base:0.6}]}
