...
#random
    ...
    execute store result score $npc random run random value 1..5
...
#item shop
    ...
    execute if score $npc random matches 3 at @e[type=armor_stand,tag=shop1] run summon witch ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,DeathLootTable:"main:empty",NoAI:1b,Tags:["shop","npcshop1","npc"]}
    ...
    execute if score $npc random matches 5 at @e[type=armor_stand,tag=shop1] run summon warden ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,DeathLootTable:"main:empty",NoAI:1b,Tags:["shop","npcshop1","npc"],attributes:[{id:"minecraft:generic.scale",base:0.6}]}
...
#team upgrades
    ...
    execute if score $npc random matches 3 at @e[type=armor_stand,tag=shop2] run summon witch ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,DeathLootTable:"main:empty",NoAI:1b,Tags:["shop","npcshop2","npc"]}
    ...
    execute if score $npc random matches 5 at @e[type=armor_stand,tag=shop2] run summon warden ~ ~ ~ {PersistenceRequired:1b,Silent:1b,Invulnerable:1b,DeathLootTable:"main:empty",NoAI:1b,Tags:["shop","npcshop2","npc"],attributes:[{id:"minecraft:generic.scale",base:0.6}]}
