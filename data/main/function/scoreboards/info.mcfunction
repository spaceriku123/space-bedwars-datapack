...
# scoreboard players set $version info 21
...
# scoreboard players set $teams info 17
...
scoreboard players set $line2 info -2
# scoreboard players set $credit info -2
...
scoreboard players display name $line1 info {"text": "                               ","color": "white","strikethrough": true}
scoreboard players display name $line2 info {"text": "                               ","color": "white","strikethrough": true}
# scoreboard players display name $credit info {"text": "by SpaceRiku"}

# scoreboard players display name $version info [{"text": "       "},{"text": "バージョン48","bold": true}]
scoreboard players display name $time info [{"text": "Diamond 2 -> ","color": "aqua"},{"text": "5 Mins","color": "white"}]
# scoreboard players display name $teams info [{"text": "Teams","bold": true}]
execute if entity @a[team=red] run scoreboard players display name $red info [{"text": "🏴 ","color": "red"},{"text": "Red: ","color": "white"},{"text": "✓","color": "green","bold": true}]
execute if entity @a[team=blue] run scoreboard players display name $blue info [{"text": "🏴 ","color": "blue"},{"text": "Blue: ","color": "white"},{"text": "✓","color": "green","bold": true}]
execute if entity @a[team=green] run scoreboard players display name $green info [{"text": "🏴 ","color": "green"},{"text": "Green: ","color": "white"},{"text": "✓","color": "green","bold": true}]
execute if entity @a[team=yellow] run scoreboard players display name $yellow info [{"text": "🏴 ","color": "yellow"},{"text": "Yellow: ","color": "white"},{"text": "✓","color": "green","bold": true}]
execute if entity @a[team=aqua] run scoreboard players display name $aqua info [{"text": "🏴 ","color": "aqua"},{"text": "Aqua: ","color": "white"},{"text": "✓","color": "green","bold": true}]
execute if entity @a[team=white] run scoreboard players display name $white info [{"text": "🏴 ","color": "white"},{"text": "White: ","color": "white"},{"text": "✓","color": "green","bold": true}]
execute if entity @a[team=pink] run scoreboard players display name $pink info [{"text": "🏴 ","color": "light_purple"},{"text": "Pink: ","color": "white"},{"text": "✓","color": "green","bold": true}]
execute if entity @a[team=gray] run scoreboard players display name $gray info [{"text": "🏴 ","color": "dark_gray"},{"text": "Gray: ","color": "white"},{"text": "✓","color": "green","bold": true}]
