execute at @e[type=armor_stand,tag=diamonds] run summon block_display ~ ~2.5 ~ {Tags:["generator"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.3f,-0.3f,-0.3f],scale:[0.6f,0.6f,0.6f]},block_state:{Name:"minecraft:diamond_block"}}
