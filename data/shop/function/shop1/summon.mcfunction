# summon
    ...
    # summon item_display ~ ~1.2 ~ {view_range:0f,width:0f,height:0f,start_interpolation:0,Tags:["shop","shop1"],Passengers:[{id:"minecraft:chest_minecart",Invulnerable:1b,CustomDisplayTile:1b,Tags:["shop","shop1"],Passengers:[{id:"minecraft:interaction",width:1f,height:0.7f,Tags:["shop","shop1"],Passengers:[{id:"minecraft:marker",Tags:["shop","shop1"]}]}],CustomName:'"ITEM SHOP"',DisplayState:{Name:"minecraft:air"}}]}
    # summon item_display ~ ~1 ~ {view_range:0f,width:0f,height:0f,teleport_duration:0,Tags:["shop","shop1"],Passengers:[{id:"minecraft:chest_minecart",Invulnerable:1b,CustomDisplayTile:1b,Tags:["shop","shop1"],Passengers:[{id:"minecraft:marker",Tags:["shop","shop1"]}],CustomName:'"ITEM SHOP"',DisplayState:{Name:"minecraft:air"}}]}
    #execute at @s run summon chest_minecart ~ ~1.2 ~ {NoAI:1b,Silent:1b,Invulnerable:1b,CustomName:'{"text":"ITEM SHOP"}',Tags:["shop","shop1"],CustomDisplayTile:1b}
