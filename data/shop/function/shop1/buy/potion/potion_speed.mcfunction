scoreboard players reset @s buy_potion_speed

clear @s emerald 1

loot give @s loot items:potion/potion_speed

tellraw @s [{"text": "Speed II Potion","color": "gold"},{"text": " を購入しました。","color": "green"}]
