scoreboard players reset @s buy_water_bucket

clear @s gold_ingot 3

loot give @s loot items:utililty/water_bucket

tellraw @s [{"text": "Water Bucket","color": "gold"},{"text": " を購入しました。","color": "green"}]
